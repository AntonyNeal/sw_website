/**
 * Simple API Test for Miss Dylan - SimplyBook.me Integration
 *
 * This script tests if Miss Dylan's API credentials are working correctly.
 * Run this to verify everything is set up before going live.
 *
 * Usage:
 *   node test-miss-dylan-api.js
 */

require('dotenv').config();

// Partner's SimplyBook.me configuration
const COMPANY_LOGIN = process.env.SIMPLYBOOK_COMPANY || 'miss-dylan';

console.log('\n🧪 TESTING SIMPLYBOOK API FOR MISS DYLAN\n');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
...
if (!configOk) {
  ...
  console.log('SIMPLYBOOK_COMPANY=miss-dylan');
...
async function testAPIConnection() {
  try {
    ...
    console.log("🎉 Miss Dylan's SimplyBook.me API is working correctly!\n");
